...
$(DOCKER_MACSEC)_DBG_DEPENDS = $($(DOCKER_SWSS_LAYER_NOBLE)_DBG_DEPENDS)
$(DOCKER_MACSEC)_DBG_DEPENDS +=  $(WPASUPPLICANT_DBG)

$(DOCKER_MACSEC)_DBG_IMAGE_PACKAGES = $($(DOCKER_SWSS_LAYER_NOBLE)_DBG_IMAGE_PACKAGES)

$(DOCKER_MACSEC)_LOAD_DOCKERS += $(DOCKER_SWSS_LAYER_NOBLE)
...
SONIC_NOBLE_DOCKERS += $(DOCKER_MACSEC)
SONIC_DOCKER_DBG_IMAGES += $(DOCKER_MACSEC_DBG)
SONIC_NOBLE_DBG_DOCKERS += $(DOCKER_MACSEC_DBG)
