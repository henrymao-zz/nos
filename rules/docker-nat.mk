...
$(DOCKER_NAT)_DBG_DEPENDS = $($(DOCKER_SWSS_LAYER_JAMMY)_DBG_DEPENDS)
$(DOCKER_NAT)_DBG_DEPENDS += $(SWSS_DBG) $(LIBSWSSCOMMON_DBG)
$(DOCKER_NAT)_DBG_IMAGE_PACKAGES = $($(DOCKER_SWSS_LAYER_JAMMY)_DBG_IMAGE_PACKAGES)

$(DOCKER_NAT)_LOAD_DOCKERS += $(DOCKER_SWSS_LAYER_JAMMY)
...
SONIC_JAMMY_DOCKERS += $(DOCKER_NAT)
SONIC_JAMMY_DBG_DOCKERS += $(DOCKER_NAT_DBG)
