...
$(DOCKER_ROUTER_ADVERTISER)_DBG_DEPENDS = $($(DOCKER_CONFIG_ENGINE_NOBLE)_DBG_DEPENDS)

$(DOCKER_ROUTER_ADVERTISER)_DBG_IMAGE_PACKAGES = $($(DOCKER_CONFIG_ENGINE_NOBLE)_DBG_IMAGE_PACKAGES)

$(DOCKER_ROUTER_ADVERTISER)_LOAD_DOCKERS = $(DOCKER_CONFIG_ENGINE_NOBLE)
...
SONIC_NOBLE_DOCKERS += $(DOCKER_ROUTER_ADVERTISER)
SONIC_NOBLE_DBG_DOCKERS += $(DOCKER_ROUTER_ADVERTISER_DBG)
