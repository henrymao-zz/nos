...
$(DOCKER_DHCP_RELAY)_DBG_DEPENDS = $($(DOCKER_CONFIG_ENGINE_JAMMY)_DBG_DEPENDS)
$(DOCKER_DHCP_RELAY)_DBG_DEPENDS += $(ISC_DHCP_RELAY_DBG) $(SONIC_DHCPRELAY_DBG) $(SONIC_DHCPMON_DBG) $(SONIC_RSYSLOG_PLUGIN)

$(DOCKER_DHCP_RELAY)_DBG_IMAGE_PACKAGES = $($(DOCKER_CONFIG_ENGINE_JAMMY)_DBG_IMAGE_PACKAGES)

$(DOCKER_DHCP_RELAY)_LOAD_DOCKERS = $(DOCKER_CONFIG_ENGINE_JAMMY)
...
SONIC_JAMMY_DBG_DOCKERS += $(DOCKER_DHCP_RELAY_DBG)
else
#SONIC_PACKAGES_LOCAL += $(DOCKER_DHCP_RELAY)
SONIC_JAMMY_DOCKERS += $(DOCKER_DHCP_RELAY)
endif
endif
