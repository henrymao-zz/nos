...
$(DOCKER_TEAMD)_DBG_DEPENDS = $($(DOCKER_SWSS_LAYER_NOBLE)_DBG_DEPENDS)
$(DOCKER_TEAMD)_DBG_DEPENDS += $(LIBTEAMDCTL_DBG) $(LIBTEAM_UTILS_DBG)

$(DOCKER_TEAMD)_DBG_IMAGE_PACKAGES = $($(DOCKER_SWSS_LAYER_NOBLE)_DBG_IMAGE_PACKAGES)

$(DOCKER_TEAMD)_LOAD_DOCKERS += $(DOCKER_SWSS_LAYER_NOBLE)
...
SONIC_NOBLE_DOCKERS += $(DOCKER_TEAMD)
SONIC_NOBLE_DBG_DOCKERS += $(DOCKER_TEAMD_DBG)
