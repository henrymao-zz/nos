...
$(SONIC_ONE_IMAGE)_INSTALLS += $(SONIC_DEVICE_DATA)
$(SONIC_ONE_IMAGE)_INSTALLS += $(SSWSYNCD)
$(SONIC_ONE_IMAGE)_INSTALLS += $(SOCAT)
$(SONIC_ONE_IMAGE)_LAZY_INSTALLS += $(DELL_N3248TE_PLATFORM_MODULE)
...
$(SONIC_ONE_IMAGE)_LAZY_BUILD_INSTALLS += $(BRCM_XGS_SAI) $(BRCM_XGS_SAI_DEV)
#$(SONIC_ONE_IMAGE)_LAZY_BUILD_INSTALLS = $(BRCM_SWITCHDEV)
