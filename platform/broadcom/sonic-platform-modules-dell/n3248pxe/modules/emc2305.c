...
emc2305_detect(struct i2c_client *new_client, struct i2c_board_info *info)
{
	...
	switch (product) {
	case 0x34:
		strncpy(info->type, "emc2305", I2C_NAME_SIZE);
		break;
	case 0x35:
		strncpy(info->type, "emc2303", I2C_NAME_SIZE);
		break;
	case 0x36:
		strncpy(info->type, "emc2302", I2C_NAME_SIZE);
		break;
	case 0x37:
		strncpy(info->type, "emc2301", I2C_NAME_SIZE);
		break;
	default:
		return -ENODEV;
	}
