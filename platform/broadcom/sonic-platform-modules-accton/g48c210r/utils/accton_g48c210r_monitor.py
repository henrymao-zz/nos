...
# HISTORY:
#    mm/dd/yyyy (A.D.)#
#    10/24/2019:Jostar create for g48c210r thermal plan
# ------------------------------------------------------------------
...
try:
    ...
    import time
    from g48c210r.fanutil import FanUtil
    from g48c210r.thermalutil import ThermalUtil
except ImportError as e:
    raise ImportError('%s - required module not found' % str(e))

# Deafults
VERSION = '1.0'
FUNCTION_NAME = '/usr/local/bin/accton_g48c210r_monitor'
