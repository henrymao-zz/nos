...
led_prefix = '/sys/devices/platform/g48c210r_led/leds/accton_' + \
    PROJECT_NAME + '_led::'
fan_prefix = '/sys/devices/platform/g48c210r_'
...
mknod = [
    ...
    'echo g48c210r_cpld 0x60 > /sys/bus/i2c/devices/i2c-3/new_device',
    ...
    # PSU-1
    'echo g48c210r_psu1 0x50 > /sys/bus/i2c/devices/i2c-10/new_device',
    'echo ype1200am 0x58 > /sys/bus/i2c/devices/i2c-10/new_device',

    # PSU-2
    'echo g48c210r_psu2 0x51> /sys/bus/i2c/devices/i2c-11/new_device',
...
kos = [
    ...
    'modprobe ym2651y',
    'modprobe x86_64_accton_g48c210r_cpld',
    'modprobe x86_64_accton_g48c210r_leds',
    'modprobe x86_64_accton_g48c210r_psu',
    'modprobe optoe']
